//! One-shot bench bin for the `crossbeam::channel` actor variant.
//!
...
fn main() {
    ...
    use payments_engine_challenge::concurrency::actor_crossbeam;
    ...
    let result = actor_crossbeam::run_workload(PRODUCERS, streams);
