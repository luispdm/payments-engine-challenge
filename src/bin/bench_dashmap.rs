//! One-shot bench bin for the `DashMap` variant.
//!
...
fn main() {
    ...
    use payments_engine_challenge::concurrency::dashmap_engine;
    ...
    let result = dashmap_engine::run_workload(PRODUCERS, streams);
